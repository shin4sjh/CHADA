...
public class MypageChangeDto {
	...
	public MypageChangeDto(String memberNo, String memberId, String memberPassword, String memberRank,
	...
	public String toString() {
		return "MypageChangeDto [memberNo=" + memberNo + ", memberId=" + memberId + ", memberPassword=" + memberPassword
